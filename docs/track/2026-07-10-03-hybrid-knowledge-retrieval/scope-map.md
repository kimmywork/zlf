...
|---|---|---|---|
| 01 | `2026-07-10-01-index-lifecycle/` | I1–I7 complete; cumulative I8 verification | indexed-document identity, mutations, generations, rebuild, observability |
| 02 | `2026-07-10-02-bm25/` | design approved; blocked on Stage 01 | corpus-normalized lexical ranking and multilingual analysis |
