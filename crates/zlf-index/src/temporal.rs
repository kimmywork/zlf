...
mod tests {
    ...
    fn test_get_entries_in_range() {
        ...
        let entry2 = TemporalEntry {
            ...
            valid_from: DateTime::parse_from_rfc3339("2026-06-15T00:00:00Z")
                .unwrap()
                .with_timezone(&Utc),
            valid_to: None,
        };
    ...
    fn test_time_range() {
        ...
        let start = DateTime::parse_from_rfc3339("2026-01-01T00:00:00Z")
            .unwrap()
            .with_timezone(&Utc);
        let end = DateTime::parse_from_rfc3339("2026-06-30T00:00:00Z")
            .unwrap()
            .with_timezone(&Utc);
    ...
    fn test_before() {
        ...
        let before_date = DateTime::parse_from_rfc3339("2026-03-01T00:00:00Z")
            .unwrap()
            .with_timezone(&Utc);
    ...
    fn test_after() {
        ...
        let after_date = DateTime::parse_from_rfc3339("2026-03-01T00:00:00Z")
            .unwrap()
            .with_timezone(&Utc);
    ...
    fn test_between() {
        ...
        let entry3 = TemporalEntry {
            ...
            valid_from: DateTime::parse_from_rfc3339("2026-12-01T00:00:00Z")
                .unwrap()
                .with_timezone(&Utc),
            valid_to: None,
        };
